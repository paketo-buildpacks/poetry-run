...
func (f *Reload) ShouldEnableLiveReload() (bool, error) {
...
func (f *Reload) TransformReloadableProcesses(param1 packit.Process, param2 libreload.ReloadableProcessSpec) (packit.Process, packit.Process) {
